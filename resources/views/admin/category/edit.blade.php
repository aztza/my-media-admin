...
<section class="content">
    <div class="container-fluid">
      <div class="row mt-4">
        <div class="col-5">
            <form action="{{ route("update#category",$chooseData->category_id) }}" method="POST">
                @csrf
                <div class="card p-2">
                    <div class="form-group">
                        <label>Category Name</label>
                        <input type="text" name="categoryName" class="form-control" aria-describedby="emailHelp" placeholder="Enter your category name" value="{{ old("categoryName", $chooseData->title) }}">
                        @error("categoryName")
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="password" name="categoryDescription" cols="30" rows="10" class="form-control" placeholder="Enter your description">{{ old("categoryDescription", $chooseData->description) }}</textarea>
                      ...
                      <div>
                        ...
                        <a href="{{ route("create#category") }}"><button type="button" class="btn btn-primary col-3">Create</button></a>
                      </div>
                </div>
            </form>
        </div>
